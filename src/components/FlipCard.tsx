...
export const FlipCard = forwardRef<FlipCardRef, FlipCardProps>(({
  ...
  return <div className={cn("flip-card cursor-pointer mx-auto", isFlipped && "flipped", className)} onClick={handleClick}>
        <div className="flip-card-inner">
          {/* Front */}
          <div className="flip-card-front glass-card overflow-hidden relative">
            <img src={frontImage} alt={alt} className="w-full h-full object-cover object-center" />
